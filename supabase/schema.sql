...
-- Audit logs are strictly APPEND-ONLY: NO UPDATE OR DELETE policies exist.
-- This guarantees regulatory audit trail immutability.
...
-- ============================================================
-- 9. TABLE: products (Authoritative Manufacturer Product Registry)
-- ============================================================
...
-- Anyone can view approved/active products for consumer verification
...
-- Manufacturers can update their own draft/pending products
...
-- ============================================================
-- 10. TABLE: product_versions (Historical Snapshots & Revisions)
-- ============================================================
...
-- ============================================================
-- 11. TABLE: product_verifications (Consumer Scan & Verification Event Log)
-- ============================================================
...
-- ============================================================
-- 12. TABLE: executive_reports (Executive Officer / Regulator Case Reports)
-- ============================================================
...
-- ============================================================
-- 13. TABLE: notifications (User Alerts & Workflow Notifications)
-- ============================================================
